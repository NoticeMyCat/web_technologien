// Die Funktion getData() wird aufgerufen, um Daten abzurufen und anzuzeigen.
getData();
...
function getData() {
    ...
    $.ajax({
        ...
        type: 'POST',
        data: {
            "url": "https://svv.volleynet.at/Termine/32370"
            // "url": "https://svv.volleynet.at/Termine/32370/Alle?sort=dat" für alle Termine
        },
        dataType: 'html',
        success: function (res) {
            ...
            // Füge die generierte Tabelle in das HTML-Element mit der ID #tableDataDamen ein.
            $("#tableDataDamen").html(html);
        },
    });
}
